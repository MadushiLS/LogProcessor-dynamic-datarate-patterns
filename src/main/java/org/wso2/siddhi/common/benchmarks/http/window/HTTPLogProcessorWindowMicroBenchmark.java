...
package main.java.org.wso2.siddhi.common.benchmarks.http.window;
...
/**
 * An HTTP Log Processor MicroBenchmark for Siddhi. The benchmark tests window performance.
 */

public class HTTPLogProcessorWindowMicroBenchmark {
    private static final Logger log = Logger.getLogger(HTTPLogProcessorWindowMicroBenchmark.class);
    private static final int RECORD_WINDOW = 10000; //This is the number of events to record.
    private static long firstTupleTime = -1;
    private static String logDir = "/var/tmp/http-logs";
